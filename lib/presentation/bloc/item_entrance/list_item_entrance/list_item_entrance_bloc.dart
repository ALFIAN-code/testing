...
part 'list_item_entrance_state.dart';

class ListItemEntranceBloc extends Cubit<ListItemEntranceState> {

  final ProjectRepository _projectRepository;

  ListItemEntranceBloc(this._projectRepository) : super(const ListItemEntranceState());
