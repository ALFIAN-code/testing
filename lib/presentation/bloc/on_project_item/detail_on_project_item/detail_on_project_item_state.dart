part of 'detail_on_project_item_bloc.dart';

class DetailOnProjectItemState extends Equatable {
  ...
  const DetailOnProjectItemState({
    this.project,
    this.scannedItem,
  ...
  DetailOnProjectItemState copyWith({
    OnProjectItemPaginatedModel? project,
    String? scannedItem,
