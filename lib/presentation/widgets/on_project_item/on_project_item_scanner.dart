...
class OnProjectItemScanner extends StatefulWidget {
  const OnProjectItemScanner({super.key});

  @override
  State<OnProjectItemScanner> createState() => _OnProjectItemScannerState();
}

class _OnProjectItemScannerState extends BaseUiState<OnProjectItemScanner> {
  ...
  Widget build(BuildContext context) => BlocListener<DetailOnProjectItemBloc, DetailOnProjectItemState>(
    listenWhen: (DetailOnProjectItemState previous, DetailOnProjectItemState current) => previous.scanStatus != current.scanStatus,
    ...
    controller.scannedDataStream.listen((Barcode scanData) {
      ...
      if (scanData.code != null) {
        if (lastScanTime == null ||
          ...
          context.read<DetailOnProjectItemBloc>().setScannedItem(
            scanData.code!,
          );
        }
      } else {
