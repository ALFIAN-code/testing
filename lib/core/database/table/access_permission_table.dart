...
class AccessPermissionTable extends BaseDatabaseTable<AccessPermissionEntity> {
  ...
  @override
  Map<String, dynamic> buildMap(AccessPermissionEntity model) => <String, dynamic>{
      rowId: null,
  ...
  @override
  AccessPermissionEntity buildModel(Map<String, dynamic> map) => AccessPermissionEntity(
